...
Open to learning an additional language if a career opportunity requires it. French was cited specifically in the context of a hypothetical Canadian visa route — the willingness is tied to whether the path actually unlocks something concrete (a guaranteed role, a major geography opening up), not to language learning as a goal in itself.
