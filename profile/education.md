...
- **Minor / Specialisation** (if any): None
...
- **Achievements**: None formally recorded
- **Notes**: Coursework spanned supervised learning architectures, evolutionary methods, network analysis, and full-cycle team software delivery with CI pipelines. See [[Profile/Skills|Skills]] for how these translate into current proficiency levels and [[Profile/Projects|Projects]] for the full portfolio built on this foundation.
