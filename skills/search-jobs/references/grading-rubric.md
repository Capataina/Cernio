...
| **Sponsorship viability** | Can and will they sponsor a Skilled Worker visa when needed (August 2027)? | Large company with active sponsor licence, established graduate programme, "we sponsor" in description | Small startup with no sponsor licence, "must have existing right to work", no mention of sponsorship |
