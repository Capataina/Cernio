...
| `notes/grading-rubric.md` | Grade system evolution: dimension-weighted → question-first → project tiers + calibration-anchored. Session 5 full DB reset and rebuild. Session 6 exclusion purge (2001→937 jobs, 408 companies). Token economics of proper vs title-only grading. |
