...
1. [Why cross-checking exists](#why-cross-checking-exists)
2. [The cardinal rule: NEVER grade blind](#the-cardinal-rule-never-grade-blind)
3. [Company cross-checking procedure](#company-cross-checking-procedure)
4. [Job cross-checking procedure](#job-cross-checking-procedure)
5. [What this check does NOT do](#what-this-check-does-not-do)
